...
const ViewCategory = () => {
  ...
  const handleDelete = (id) => {
    try {
      if (window.confirm("Are you sure?")) {
        api.delete(`/category/deletecat/${id}`).then((data) => {
  ...
  return (
    <>
      <Table style={{ borderRadius: "6px", width: "115%" }}>
        <TableHead>
          <TableRow style={{ background: "#D0D0D0", width: "100%" }}>
            ...
            .map((row) => {
              ...
              return (
                ...
                >
                  ...
                  <TableCell>{row.each_sub}</TableCell>
                  <TableCell>{row.category_URL}</TableCell>
