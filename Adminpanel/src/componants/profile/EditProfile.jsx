...
const EditProfile =() =>{
    ...
    return(
            ...
            <form id='myform' onSubmit={handlesubmit}>
                ...
                <Grid container item spacing={3}>
                    <TextField
                        ...
                        helperText={
                            getUserData.firstName.error && getUserData.firstName.errorMessage
                         }
                        fullWidth
        ...
        <FormHelperText className="required">{getUserData.roles.error && getUserData.roles.errorMessage}</FormHelperText>
      </FormControl>
      ...
      <FormHelperText className="required">{getUserData.gender.error && getUserData.gender.errorMessage}</FormHelperText>
              ...
              <Stack spacing={2} direction="row" sx={{marginBottom: 4}}>
                    ...
                    <TextField
                        ...
                        helperText={
                         getUserData.file.error && getUserData.file.errorMessage
                              }
                        fullWidth
                    />
